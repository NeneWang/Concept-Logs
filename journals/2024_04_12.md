...
- Testing Concepts
	...
	- Base Colony usually has predefined rules.
		...
		- Agents reset? Well it would make sense for agents and infrastructure to be abled to be activated to or toggled down. You can say that every 4 rounds. Or upon disclosere is a Cycle (a year, thus all assets and agents gets resettled.)
	- Tech Tiers
